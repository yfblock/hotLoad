...
import io.github.yfblock.frameMvc.Core.Constant.OperatorMethodParams;
import io.github.yfblock.frameMvc.Core.Servlet.MultiModuleServlet;
...
public class DispatcherServlet extends MultiModuleServlet {
    ...
    private void loadInitParams() {
        String isDebug = this.getInitParameter("debug");
